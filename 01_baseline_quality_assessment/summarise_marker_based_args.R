...
#Subset to relevant
PAPMID_export_filtered['drop'] <- ifelse(PAPMID_export_filtered$repeated == TRUE & !grepl('20210219|20210224|device\\_07', PAPMID_export_filtered$file), 1, 0)
...
#Subset to relevant
output['drop'] <- ifelse(output$repeated == TRUE & !grepl('20210219|20210224|device\\_07', output$file), 1, 0)
...
# Add strainnumber
output_<-merge(output, numbering, by.x = 'strainnumber', by.y = 'Numbering_Shipment_1')
